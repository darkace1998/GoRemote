...
RFC 1282 rlogin client. Deviation: window-size control messages are sent in-band (0xFF 0xFF 's' 's' <rows cols xpix ypix BE uint16>) rather than via TCP urgent/out-of-band data. Cleartext protocol; use SSH where possible.
