...
| **HTTP** | Uses an external system browser launcher. The experimental in-process webview was dropped. |
...
| **VNC** | Uses the external `vncviewer` launcher. The pure-Go RFB client was dropped. |
