...
func runGUI(_ *iapp.App, b *Bindings) bool {
	...
	treeActions := widget.NewToolbar(
		...
		widget.NewToolbarSeparator(),
		tooltip.NewAction(theme.MenuExpandIcon(), "Expand all", func() { tree.tree.OpenAllBranches() }),
		tooltip.NewAction(theme.MenuDropDownIcon(), "Collapse all", func() { tree.tree.CloseAllBranches() }),
		widget.NewToolbarSeparator(),
